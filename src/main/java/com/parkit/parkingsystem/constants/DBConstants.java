...
public class DBConstants {
    ...
    //Changing constant, so it can fetch the ticket of a recurring user
    ...
    public static final String RECURRING_USERS = "select count(*) from ticket t where t.VEHICLE_REG_NUMBER = ? and t.OUT_TIME IS NOT NULL";
}
